...
export const workspaceActivityEventType = pgEnum(
  "workspace_activity_event_type",
  [
    "workspace.created",
    "workspace.renamed",
    "workspace.deleted",
...
export const workspaceActivity = pgTable(
  ...
  (table) => ({
    workspaceIdCreatedAtIdx: index(
      "workspace_activity_workspace_id_created_at_idx",
    ).on(table.workspaceId, table.createdAt),
    workspaceIdEventTypeIdx: index(
      "workspace_activity_workspace_id_event_type_idx",
    ).on(table.workspaceId, table.eventType),
    entityTypeEntityIdIdx: index(
      "workspace_activity_entity_type_entity_id_idx",
